...
const WEAPON_ICONS = {
  ...
  fireStaves: (i) => ICON(`wcs/weapons/Staff_${String(i).padStart(2, '0')}.png`),
  frostStaves:(i) => ICON(`wcs/weapons/Staff_${String(i + 4).padStart(2, '0')}.png`),
  holyStaves: (i) => ICON(`wcs/weapons/Staff_${String(i + 8).padStart(2, '0')}.png`),
  lightningStaves: (i) => ICON(`wcs/weapons/Staff_${String(i + 12).padStart(2, '0')}.png`),
  natureStaves:    (i) => ICON(`wcs/weapons/Staff_${String(i + 16).padStart(2, '0')}.png`),
